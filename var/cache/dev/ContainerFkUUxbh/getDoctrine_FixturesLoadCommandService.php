...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\CommentFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\DesignationFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\TrickDesignationsFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\TrickFixtures(new \App\Service\FixturesService()), 'groups' => []], ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []]]);
