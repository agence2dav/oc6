...
class getCommentRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\CommentRepository'])) {
            return $container->privates['App\\Repository\\CommentRepository'];
        }

        return $container->privates['App\\Repository\\CommentRepository'] = new \App\Repository\CommentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
