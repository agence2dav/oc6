 ...
 */
class getDesignationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DesignationRepository' shared autowired service.
     *
     * @return \App\Repository\DesignationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DesignationRepository.php';

        return $container->privates['App\\Repository\\DesignationRepository'] = new \App\Repository\DesignationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
