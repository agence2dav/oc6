 ...
 */
class getTrickDesignationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrickDesignationsRepository' shared autowired service.
     *
     * @return \App\Repository\TrickDesignationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrickDesignationsRepository.php';

        return $container->privates['App\\Repository\\TrickDesignationsRepository'] = new \App\Repository\TrickDesignationsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
